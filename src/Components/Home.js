...
function Home({allUser,setAllUser}) {
	...
	// Function update which takes modified User state and setUser value
	const update = (User) => {
	  setUser(User);
	};

	// On update button click, it will take the old user data and update the data   
	...
	// for handling the change made while adding a new data
